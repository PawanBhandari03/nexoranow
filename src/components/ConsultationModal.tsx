        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <button 
                type="submit"
                className="mt-4 w-full rounded-xl py-4 flex items-center justify-center transition-all duration-300 border bg-transparent border-white/20 hover:border-white/50 hover:bg-white/5 text-white"
              >
